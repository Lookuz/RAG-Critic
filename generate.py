...
from triviaqa_datasets.datasets import ContextualizedQADatasetForGeneration, ContextualizedQADataLoader
...
def generate_answers(
    ...
    for i, batch in enumerate(tqdm(dataloader)):
        ...
        if task == REFINE_RESPONSE_WITH_CRITIC_TASK:
            # If critic model provided, provide critic feedback with (Q, D, R)
            outputs_critic = generate_responses(
                critic_model, critic_tokenizer, critic_prompt, outputs, generation_config)
